...
## Recoveries
<details><summary><code>$client-&gt;recoveries-&gt;listRecoveries($request) -> ?PaginatedResponseRecoveryResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>$client-&gt;recoveries-&gt;createRecovery($request) -> ?RecoveryResponse</code></summary>
<dl>
<dd>
...
$client->recoveries->createRecovery(
    new RecoveryCreatePayload([
        ...
        'amount' => 1.1,
        'currency' => CurrencyEnum::Eur->value,
        'recoveryDate' => new DateTime('2026-07-15'),
    ]),
);
```
</dd>
...
**$amount:** `float|string` — The amount recovered (must be > 0).
...
**$currency:** `string` — The currency of the recovered amount, must be one of the supported currencies: eur, gbp, usd, czk, pln, isk
...
**$recoveryDate:** `DateTime` — The date the recovery was made.
