...
use Voltaria\Types\CollectionActionStatusEnum;
use Voltaria\Types\CollectionActionTypeEnum;

class ListCollectionActionLogsRequest extends JsonSerializableType
{
    /**
     * @var ?string $clientId
     */
    ...
    /**
     * @var ?value-of<CollectionActionStatusEnum> $status
     */
    public ?string $status;

    /**
     * @var ?value-of<CollectionActionTypeEnum> $actionType
     */
    ...
    public function __construct(
        ...
        $this->actionType = $values['actionType'] ?? null;
