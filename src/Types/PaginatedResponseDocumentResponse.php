...
class PaginatedResponseDocumentResponse extends JsonSerializableType
{
    /**
     * @var array<DocumentResponse> $items
     */
    #[JsonProperty('items'), ArrayType([DocumentResponse::class])]
    public array $items;
