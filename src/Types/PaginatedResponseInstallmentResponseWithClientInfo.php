...
class PaginatedResponseInstallmentResponseWithClientInfo extends JsonSerializableType
{
    /**
     * @var array<InstallmentResponseWithClientInfo> $items
     */
    #[JsonProperty('items'), ArrayType([InstallmentResponseWithClientInfo::class])]
    public array $items;
    ...
    /**
     * @param array{
     *   items: array<InstallmentResponseWithClientInfo>,
     *   page?: ?int,
     *   pageSize?: ?int,
     *   itemsInPage?: ?int,
     *   totalItems?: ?int,
