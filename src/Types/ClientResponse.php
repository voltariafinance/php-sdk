...
class ClientResponse extends JsonSerializableType
{
    ...
    /**
     * @var ?array<ClientLimitResponse> $limits The limits associated with the client
     */
    #[JsonProperty('limits'), ArrayType([ClientLimitResponse::class])]
    public ?array $limits;
     ...
     *   limits?: ?array<ClientLimitResponse>,
