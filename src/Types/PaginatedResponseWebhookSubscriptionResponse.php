...
class PaginatedResponseWebhookSubscriptionResponse extends JsonSerializableType
{
    /**
     * @var array<WebhookSubscriptionResponse> $items
     */
    #[JsonProperty('items'), ArrayType([WebhookSubscriptionResponse::class])]
    public array $items;
    ...
    /**
     * @param array{
     *   items: array<WebhookSubscriptionResponse>,
     *   page?: ?int,
     *   pageSize?: ?int,
     *   itemsInPage?: ?int,
     *   totalItems?: ?int,
