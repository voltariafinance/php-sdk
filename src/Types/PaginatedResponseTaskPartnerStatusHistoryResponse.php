...
class PaginatedResponseTaskPartnerStatusHistoryResponse extends JsonSerializableType
{
    /**
     * @var array<TaskPartnerStatusHistoryResponse> $items
     */
    #[JsonProperty('items'), ArrayType([TaskPartnerStatusHistoryResponse::class])]
    public array $items;
    ...
    /**
     * @param array{
     *   items: array<TaskPartnerStatusHistoryResponse>,
     *   page?: ?int,
     *   pageSize?: ?int,
     *   itemsInPage?: ?int,
     *   totalItems?: ?int,
