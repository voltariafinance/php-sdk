...
class PaginatedResponseDrawdownChecklistResponse extends JsonSerializableType
{
    /**
     * @var array<DrawdownChecklistResponse> $items
     */
    #[JsonProperty('items'), ArrayType([DrawdownChecklistResponse::class])]
    public array $items;
    ...
    /**
     * @param array{
     *   items: array<DrawdownChecklistResponse>,
     *   page?: ?int,
     *   pageSize?: ?int,
     *   itemsInPage?: ?int,
     *   totalItems?: ?int,
