...
class PaginatedResponseDrawdownResponse extends JsonSerializableType
{
    /**
     * @var array<DrawdownResponse> $items
     */
    #[JsonProperty('items'), ArrayType([DrawdownResponse::class])]
    public array $items;
