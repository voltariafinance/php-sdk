...
class LoanResponseWithInstallments extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<LoanInstallmentResponse> $installments List of installments for the loan
     */
    #[JsonProperty('installments'), ArrayType([LoanInstallmentResponse::class])]
     ...
     *   installments?: ?array<LoanInstallmentResponse>,
     * } $values
     */
    public function __construct(
        ...
        $this->installments = $values['installments'] ?? null;
    }
