...
class PaginatedResponseWebhookLogResponse extends JsonSerializableType
{
    /**
     * @var array<WebhookLogResponse> $items
     */
    #[JsonProperty('items'), ArrayType([WebhookLogResponse::class])]
    public array $items;
