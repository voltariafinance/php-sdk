...
class PaginatedResponseWaterfallResponse extends JsonSerializableType
{
    /**
     * @var array<WaterfallResponse> $items
     */
    #[JsonProperty('items'), ArrayType([WaterfallResponse::class])]
    public array $items;
