...
class PaginatedResponseClientAccountResponse extends JsonSerializableType
{
    /**
     * @var array<ClientAccountResponse> $items
     */
    #[JsonProperty('items'), ArrayType([ClientAccountResponse::class])]
    public array $items;
    ...
    /**
     * @param array{
     *   items: array<ClientAccountResponse>,
     *   page?: ?int,
     *   pageSize?: ?int,
     *   itemsInPage?: ?int,
     *   totalItems?: ?int,
