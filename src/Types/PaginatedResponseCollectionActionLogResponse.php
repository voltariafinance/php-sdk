...
class PaginatedResponseCollectionActionLogResponse extends JsonSerializableType
{
    /**
     * @var array<CollectionActionLogResponse> $items
     */
    #[JsonProperty('items'), ArrayType([CollectionActionLogResponse::class])]
    public array $items;
    ...
    /**
     * @param array{
     *   items: array<CollectionActionLogResponse>,
     *   page?: ?int,
     *   pageSize?: ?int,
     *   itemsInPage?: ?int,
     *   totalItems?: ?int,
