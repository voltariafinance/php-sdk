...
class PaginatedResponseClientUserResponse extends JsonSerializableType
{
    /**
     * @var array<ClientUserResponse> $items
     */
    #[JsonProperty('items'), ArrayType([ClientUserResponse::class])]
    public array $items;
    ...
    /**
     * @param array{
     *   items: array<ClientUserResponse>,
     *   page?: ?int,
     *   pageSize?: ?int,
     *   itemsInPage?: ?int,
     *   totalItems?: ?int,
