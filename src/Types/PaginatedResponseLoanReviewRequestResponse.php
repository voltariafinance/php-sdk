...
class PaginatedResponseLoanReviewRequestResponse extends JsonSerializableType
{
    /**
     * @var array<LoanReviewRequestResponse> $items
     */
    #[JsonProperty('items'), ArrayType([LoanReviewRequestResponse::class])]
    public array $items;
    ...
    /**
     * @param array{
     *   items: array<LoanReviewRequestResponse>,
     *   page?: ?int,
     *   pageSize?: ?int,
     *   itemsInPage?: ?int,
     *   totalItems?: ?int,
