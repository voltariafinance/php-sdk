...
class PaginatedResponseLoanResponseWithClientInfo extends JsonSerializableType
{
    /**
     * @var array<LoanResponseWithClientInfo> $items
     */
    #[JsonProperty('items'), ArrayType([LoanResponseWithClientInfo::class])]
    public array $items;
    ...
    /**
     * @param array{
     *   items: array<LoanResponseWithClientInfo>,
     *   page?: ?int,
     *   pageSize?: ?int,
     *   itemsInPage?: ?int,
     *   totalItems?: ?int,
