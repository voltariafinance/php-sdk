...
class PaginatedResponsePaymentPromiseResponse extends JsonSerializableType
{
    /**
     * @var array<PaymentPromiseResponse> $items
     */
    #[JsonProperty('items'), ArrayType([PaymentPromiseResponse::class])]
    public array $items;
    ...
    /**
     * @param array{
     *   items: array<PaymentPromiseResponse>,
     *   page?: ?int,
     *   pageSize?: ?int,
     *   itemsInPage?: ?int,
     *   totalItems?: ?int,
