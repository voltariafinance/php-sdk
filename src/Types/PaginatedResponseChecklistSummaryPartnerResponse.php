...
class PaginatedResponseChecklistSummaryPartnerResponse extends JsonSerializableType
{
    /**
     * @var array<ChecklistSummaryPartnerResponse> $items
     */
    #[JsonProperty('items'), ArrayType([ChecklistSummaryPartnerResponse::class])]
    public array $items;
    ...
    /**
     * @param array{
     *   items: array<ChecklistSummaryPartnerResponse>,
     *   page?: ?int,
     *   pageSize?: ?int,
     *   itemsInPage?: ?int,
     *   totalItems?: ?int,
