...
class PaginatedResponseTaskPartnerResponse extends JsonSerializableType
{
    /**
     * @var array<TaskPartnerResponse> $items
     */
    #[JsonProperty('items'), ArrayType([TaskPartnerResponse::class])]
    public array $items;
    ...
    /**
     * @param array{
     *   items: array<TaskPartnerResponse>,
     *   page?: ?int,
     *   pageSize?: ?int,
     *   itemsInPage?: ?int,
     *   totalItems?: ?int,
