...
class PaginatedResponseLimitRequestResponse extends JsonSerializableType
{
    /**
     * @var array<LimitRequestResponse> $items
     */
    #[JsonProperty('items'), ArrayType([LimitRequestResponse::class])]
    public array $items;
    ...
    /**
     * @param array{
     *   items: array<LimitRequestResponse>,
     *   page?: ?int,
     *   pageSize?: ?int,
     *   itemsInPage?: ?int,
     *   totalItems?: ?int,
