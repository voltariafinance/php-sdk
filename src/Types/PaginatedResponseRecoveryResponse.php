...
class PaginatedResponseRecoveryResponse extends JsonSerializableType
{
    /**
     * @var array<RecoveryResponse> $items
     */
    #[JsonProperty('items'), ArrayType([RecoveryResponse::class])]
    public array $items;
