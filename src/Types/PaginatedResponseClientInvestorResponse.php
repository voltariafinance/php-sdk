...
class PaginatedResponseClientInvestorResponse extends JsonSerializableType
{
    /**
     * @var array<ClientInvestorResponse> $items
     */
    #[JsonProperty('items'), ArrayType([ClientInvestorResponse::class])]
    public array $items;
    ...
    /**
     * @param array{
     *   items: array<ClientInvestorResponse>,
     *   page?: ?int,
     *   pageSize?: ?int,
     *   itemsInPage?: ?int,
     *   totalItems?: ?int,
