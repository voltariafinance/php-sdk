...
class PaginatedResponseWaiverResponse extends JsonSerializableType
{
    /**
     * @var array<WaiverResponse> $items
     */
    #[JsonProperty('items'), ArrayType([WaiverResponse::class])]
    public array $items;
