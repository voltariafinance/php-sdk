...
class PaginatedResponseLoanInvestorResponse extends JsonSerializableType
{
    /**
     * @var array<LoanInvestorResponse> $items
     */
    #[JsonProperty('items'), ArrayType([LoanInvestorResponse::class])]
    public array $items;
    ...
    /**
     * @param array{
     *   items: array<LoanInvestorResponse>,
     *   page?: ?int,
     *   pageSize?: ?int,
     *   itemsInPage?: ?int,
     *   totalItems?: ?int,
