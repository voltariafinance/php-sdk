...
class PaginatedResponseCollectionActionResponse extends JsonSerializableType
{
    /**
     * @var array<CollectionActionResponse> $items
     */
    #[JsonProperty('items'), ArrayType([CollectionActionResponse::class])]
    public array $items;
    ...
    /**
     * @param array{
     *   items: array<CollectionActionResponse>,
     *   page?: ?int,
     *   pageSize?: ?int,
     *   itemsInPage?: ?int,
     *   totalItems?: ?int,
